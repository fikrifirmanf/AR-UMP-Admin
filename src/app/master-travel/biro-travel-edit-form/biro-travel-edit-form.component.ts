...
@Component({
  selector: 'app-biro-travel-edit-form',
  templateUrl: './biro-travel-edit-form.component.html',
  styleUrls: ['./biro-travel-edit-form.component.css']
})
export class BiroTravelEditFormComponent implements OnInit {
  constructor(
